...
public class Page_All_Annuals extends LinearLayout {
    String TAG = this.getClass().getSimpleName();
    Context mCtx;
    LinearLayout mLytTableHeader;
    ListView mLvData;
    ArrayAdaptor_AllAnnual mAdpData;

    public Page_All_Annuals(Context context) {
        super(context);
        onCreated(context);
    }

    public Page_All_Annuals(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        onCreated(context);
    }

    public Page_All_Annuals(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void onCreated(Context context) {
        ...
        mCtx = context;
        mAdpData = new ArrayAdaptor_AllAnnual(mCtx, new ArrayList<>());
        ...
        inflate(mCtx, R.layout.page_all_annuals, this);
    ...
    public void updateData(ArrayList<Cls_AllAnnual> data) {
        mAdpData.clear();
